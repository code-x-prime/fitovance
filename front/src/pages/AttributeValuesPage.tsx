          ...
          <DialogHeader>
            ...
            <DialogDescription className="space-y-4 pt-4">
              ...
              <div>
                ...
                <p className="text-sm">
                  Use the "Quick Add" dropdown to quickly add common product values for
                  Size, Color, Material, Shape, and Pattern attributes.
...
function AttributeValueForm({
  ...
  // Preset values for product attributes
