...
const IconHighProtein: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconVegan: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconGlutenFree: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconSugarFree: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconHighFiber: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconNaturalIngredients: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
    <path d="M32 48 L32 28" />
...
const IconGymFriendly: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconEnergyBoost: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
    <polygon points="36,8 20,32 30,32 26,56 44,28 34,28" />
  </svg>
);

const IconDailyUse: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconPremiumQuality: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
    <polygon points="32,10 37,24 52,24 40,33 44,48 32,39 20,48 24,33 12,24 27,24" />
  </svg>
);

const IconBestSeller: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconNewLaunch: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconLabTested: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconFastAbsorption: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
const IconEasyToConsume: React.FC<React.SVGProps<SVGSVGElement>> = (p) => (
  <svg {...iconProps} {...p}>
...
export const WASHING_CARE_ICONS: WashingCareIcon[] = [
  { name: "shedding", label: "High Protein", svg: IconHighProtein },
  { name: "no-brush", label: "Vegan", svg: IconVegan },
  { name: "vacuum", label: "Gluten Free", svg: IconGlutenFree },
  { name: "blot", label: "Sugar Free", svg: IconSugarFree },
  { name: "rotate", label: "High Fiber", svg: IconHighFiber },
  { name: "furniture-protector", label: "Natural Ingredients", svg: IconNaturalIngredients },
  { name: "trim-thread", label: "Gym Friendly", svg: IconGymFriendly },
  { name: "professional-clean", label: "Energy Boost", svg: IconEnergyBoost },
  { name: "no-fold", label: "Daily Use", svg: IconDailyUse },
  { name: "no-damp", label: "Premium Quality", svg: IconPremiumQuality },
  { name: "hand-wash", label: "Best Seller", svg: IconBestSeller },
  { name: "no-direct-sun", label: "New Launch", svg: IconNewLaunch },
  { name: "roll", label: "Lab Tested", svg: IconLabTested },
  { name: "spot-clean", label: "Fast Absorption", svg: IconFastAbsorption },
  { name: "dry-flat", label: "Easy to Consume", svg: IconEasyToConsume },
];
