...
export default function AccountPage() {
  ...
  return (
    <ProtectedRoute>
      <ClientOnly>
        <div>
          <h1 className="text-2xl font-semibold text-[#000000] mb-6 tracking-tight">My Profile</h1>
            ...
            <div className="flex justify-between gap-2 items-center mb-6">
              ...
              {!isEditing && (
                <Button
                  ...
                  size="sm"
                  className="border-[#000000] text-[#000000] hover:bg-[#000000] hover:text-white transition-colors"
                >
              ...
              <div
                className={`mb-4 p-3 rounded-lg text-sm ${
                  message.type === "success"
                    ? "bg-white text-[#000000] border border-[#000000]/40"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      className="border-gray-200 focus:border-[#000000] focus:ring-[#000000]/20"
                    />
                  </div>
                  <div>
                    <label
            ...
            <div className="flex justify-between gap-2 items-center mb-5">
              ...
              <Link href="/account/addresses">
                <Button
                  variant="outline"
                  size="sm"
                  className="border-[#000000] text-[#000000] hover:bg-[#000000] hover:text-white transition-colors text-wrap py-2"
                >
                  Manage Addresses
                </Button>
              </Link>
            ...
            {addresses.length > 0 ? (
              <div className="grid gap-3">
                {addresses.slice(0, 2).map((address) => (
                  <div
                    key={address.id}
                    className="border-l-4 border-[#000000] rounded-r-lg bg-gray-50 p-4 flex justify-between items-start"
                  >
                    <div>
                      {address.isDefault && (
                        <span className="inline-block text-xs bg-[#000000]/10 text-[#000000] px-2 py-0.5 rounded-full mb-2 font-medium">
                          Default
                        </span>
                      )}
                      <p className="text-sm font-medium text-gray-900">
              ...
              <div className="text-center py-8 border border-dashed border-gray-200 rounded-xl">
                <DynamicIcon
                  name="MapPin"
                  className="h-8 w-8 mx-auto text-[#000000] mb-2"
                />
                ...
                <Link href="/account/addresses" className="mt-3 inline-block">
                  <Button
                    variant="outline"
                    size="sm"
                    className="mt-2 border-[#000000] text-[#000000] hover:bg-[#000000] hover:text-white transition-colors"
                  >
                    Add Address
                  </Button>
                </Link>
          ...
          {/* Referral Program */}
          <div className="bg-white rounded-xl border border-[#000000]/30 p-6 mb-6">
            <div className="flex items-center gap-2.5 mb-3">
              <DynamicIcon name="Users" className="h-5 w-5 text-[#000000]" />
            ...
            {isLoadingReferral ? (
              ...
              <>
                {/* Referral Code */}
                <div className="bg-white rounded-xl p-4 mb-6 border border-[#000000]">
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      value={referralCode}
                      readOnly
                      className="font-mono text-lg font-bold bg-gray-50 border-[#000000]/40 focus:border-[#000000]"
                    />
                    <Button
                      onClick={() => {
                      ...
                      className="min-w-[100px] bg-[#000000] hover:bg-[#000000]/90 text-white"
                    >
                      {copied ? (
                        <>
                ...
                {referralStats && (
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div className="bg-white border border-gray-100 rounded-lg p-4 text-center">
                      <p className="text-2xl font-bold text-[#000000] flex items-center justify-center gap-1">
                        <span>₹</span>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <Button
                    onClick={() => {
                      const text = `Join me on FITOVANCE! Use my referral code: ${referralCode} and get amazing discounts on premium sports nutrition!`;
                      if (navigator.share) {
                        navigator.share({
                          title: "Referral Code",
                          text: text,
            ...
            <div className="rounded-xl border border-gray-100 shadow-sm bg-white p-6">
              ...
              <div className="space-y-4">
                <Link href="/account/change-password">
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto border-[#000000] text-[#000000] hover:bg-[#000000] hover:text-white transition-colors"
                  >
