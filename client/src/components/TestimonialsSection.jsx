...
export default function TestimonialsSection() {
  const testimonials = [
    {
      ...
      location: "Delhi",
      quote:
        "FITOVANCE has become my go-to for health and performance nutrition! The quality of their products is absolutely unmatched — great taste and premium ingredients!",
      rating: 5,
    },
    {
      name: "Kiran Verma",
      location: "Mumbai",
      quote:
        "I ordered a custom high-protein bundle and was blown away by the results. Fast delivery and the product quality is top-notch!",
      rating: 5,
    },
    {
      name: "Ritu Sharma",
      location: "Bangalore",
      quote:
        "Perfect quality & great taste — these protein bars completely transformed my daily diet. Absolutely loved it!",
      rating: 5,
    },
    {
      name: "Priya Kapoor",
      location: "Jaipur",
      quote:
        "The plant-protein powder I bought is clean and tastes amazing. Easy to mix and it's a great value for money!",
      rating: 5,
    },
    {
      name: "Meera Iyer",
      location: "Chennai",
      quote:
        "Been buying protein supplements here for a year. The quality is exceptional and delivery is always super quick. Highly recommended!",
      rating: 5,
    },
    {
      name: "Sunita Joshi",
      location: "Pune",
      quote:
        "Customer support is wonderful and products are top-notch. The energy shots fit perfectly into my morning routine — love the natural taste!",
      rating: 5,
    },
  ];
  ...
  return (
    <section className="py-5 md:py-8 relative w-full" style={{ background: "#FFFFFF" }}>
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-5 md:mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-3 font-jost" style={{ color: "#000000" }}>
            Customer Reviews
          </h2>
          <div className="w-20 h-1 mx-auto" style={{ backgroundColor: "#000000" }}></div>
        </div>
          ...
          <div className="flex justify-center gap-2 mt-6">
            {testimonials.map((_, index) => (
              <button
                ...
                style={index === currentSlide ? { backgroundColor: "#000000" } : {}}
