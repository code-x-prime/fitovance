...
import { getActiveFlashSales, getActiveProductSections, getPublicMenus, getPublicReels } from "../controllers/public.controller.js";
...
// Reels / Watch & Buy
router.get("/reels", getPublicReels);
